        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class=" navbar-nav ms-auto mb-lg-0">
              <a href="<?php echo base_url('akses'); ?>" class="btn btn-link" style="text-decoration: none;">Home</a>
              <a href="<?php echo base_url('login'); ?>" class="btn btn-link" style="text-decoration: none;">Login</a>
            </ul>
          </div>
        </div>
      </nav>
